      ...
      <View style={styles.modalContainer}>
        ...
        <Text>x</Text>
          ...
          <View style={styles.navigationContainer}>
            { currentStep>1 ? <TouchableOpacity onPress={handlePrev} style={styles.arrowButton}>
             <Text style={styles.arrowButtonText}>&lt;</Text>
            </TouchableOpacity>:<View></View>}
            <Text style={styles.stepIndicator}>
              Step {currentStep} of {steps.length}
            </Text>
            <TouchableOpacity onPress={currentStep === steps.length ? handleClose : handleNext} style={styles.arrowButton}>
              <Text style={styles.arrowButtonText}>&gt;</Text>
            </TouchableOpacity>
          </View>
        </View>
